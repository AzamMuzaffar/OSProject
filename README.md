...
@AdoTENKA ➜ /workspaces/OSProject (main) $ pwd
...
@AdoTENKA ➜ /workspaces/OSProject (main) $ df
Filesystem     1K-blocks     Used Available Use% Mounted on
overlay         32847680 10705788  20447792  35% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 25320876   4960916  84% /vscode
/dev/sda1       46127956 18630472  25121908  43% /tmp
/dev/loop4      32847680 10705788  20447792  35% /workspaces
4. Run the command **du** . ***(1 mark)*** __Fill answer here__.
@AdoTENKA ➜ /workspaces/OSProject (main) $ du
8       ./.git/refs/heads
4       ./.git/refs/tags
...
@AdoTENKA ➜ /workspaces/OSProject (main) $ ls
README.md  images
6. Run the command **ls -asl** . ***(1 mark)*** __Fill answer here__.
@AdoTENKA ➜ /workspaces/OSProject (main) $ ls -asl
total 40
 4 drwxrwxrwx+ 4 codespace root  4096 Jan 26 14:08 .
 4 drwxr-xrwx+ 5 codespace root  4096 Jan 26 14:08 ..
 4 drwxrwxrwx+ 9 codespace root  4096 Jan 26 14:08 .git
24 -rw-rw-rw-  1 codespace root 22378 Jan 26 14:16 README.md
 4 drwxrwxrwx+ 2 codespace root  4096 Jan 26 14:08 images
7. Run the command **free -h** . ***(1 mark)*** __Fill answer here__.
@AdoTENKA ➜ /workspaces/OSProject (main) $ free -h
              total        used        free      shared  buff/cache   available
Mem:          7.7Gi       1.7Gi       305Mi        62Mi       5.7Gi       5.7Gi
Swap:            0B          0B          0B
8. Run the command **cat /proc/cpuinfo** . ***(1 mark)*** __Fill answer here__.
@AdoTENKA ➜ /workspaces/OSProject (main) $ cat /proc/cpuinfo
processor       : 0
...
wp              : yes
flags           : fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush mmx fxsr sse sse2 ht syscall nx mmxext fxsr_opt pdpe1gb rdtscp lm constant_tsc rep_good nopl tsc_reliable nonstop_tsc cpuid extd_apicid aperfmperf pni pclmulqdq ssse3 fma cx16 pcid sse4_1 sse4_2 movbe popcnt aes xsave avx f16c rdrand hypervisor lahf_lm cmp_legacy svm cr8_legacy abm sse4a misalignsse 3dnowprefetch osvw topoext invpcid_single vmmcall fsgsbase bmi1 avx2 smep bmi2 erms invpcid rdseed adx smap clflushopt clwb sha_ni xsaveopt xsavec xgetbv1 xsaves clzero xsaveerptr rdpru arat npt nrip_save tsc_scale vmcb_clean flushbyasid decodeassists pausefilter pfthreshold v_vmsave_vmload umip vaes vpclmulqdq rdpid fsrm
top - 14:18:21 up 15 min,  0 users,  load average: 0.20, 1.05, 1.22
Tasks:  24 total,   1 running,  23 sleeping,   0 stopped,   0 zombie
%Cpu(s):  3.3 us,  4.3 sy,  0.0 ni, 92.3 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st
MiB Mem :   7929.6 total,    310.0 free,   1727.0 used,   5892.6 buff/cache
MiB Swap:      0.0 total,      0.0 free,      0.0 used.   5824.5 avail Mem 

    PID USER      PR  NI    VIRT    RES    SHR S  %CPU  %MEM     TIME+ COMMAND                                                                
   7125 codespa+  20   0   41.5g 322148  50304 S   1.3   4.0   0:09.79 node                                                                   
   2174 codespa+  20   0   41.5g 329424  50304 S   1.0   4.1   0:15.34 node                                                                   
   2914 codespa+  20   0   11.2g  65436  44160 S   0.7   0.8   0:01.12 node 
10. Run the command **uname -a**. ***(1 mark)*** __Fill answer here__.
@AdoTENKA ➜ /workspaces/OSProject (main) $ uname -a
Linux codespaces-314eff 6.5.0-1025-azure #26~22.04.1-Ubuntu SMP Thu Jul 11 22:33:04 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
11. What is the available free memory in the system. ***(1 mark)*** __Fill answer here__.
5.7Gi
12. What is the available disk space mounted on /workspace. ***(1 mark)*** __Fill answer here__.
20447792
13. Name the version and hardware architecture of the linux Virtual environment. ***(1 mark)*** __Fill answer here__.
Linux version: 6.5.0-1025-azure, Ubuntu 22.04.1
Hardware architecture: x86_64
14. What is the difference between **ls** vs **ls -asl**. ***(1 mark)*** __Fill answer here__.
ls is used when we only need file and directory names for simplicity.
ls -asl is used when we need more detailed information, such as file permissions, sizes, or hidden files.
15. What is the TLB size of the Virtual CPU. ***(1 mark)*** __Fill answer here__.
2560 4K pages
16. What is the CPU speed of the Virtual CPU. ***(1 mark)*** __Fill answer here__.
3243.191 MHz for processor 0 and 3242.985 MHz for processor 1
17. What is the top running process that consumes the most CPU cycles. ***(1 mark)*** __Fill answer here__.
node process with the PID 7125 with the usage of 1.3% of the CPU.
